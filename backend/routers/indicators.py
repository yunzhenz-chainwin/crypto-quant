...
from backend.services.reader import load_indicators, available_symbols, VALID_INTERVALS
...
def get_indicators(
    ...
    return load_indicators(symbol, days=days, start=start, end=end, interval=interval)
